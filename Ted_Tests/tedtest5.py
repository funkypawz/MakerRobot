...
def start(bot, update):
    ...
    bot.sendMessage(update.message.chat_id,
                    text='Hi! My name is MakerRobot. I will hold a conversation with you. '
...
def skip_photo(bot, update):
    ...
    bot.sendMessage(update.message.chat_id, text='That\'s okay. Now, send me your '
...
### Renaming this "cancel" function as "stop" to since was already using a cancel function elsewhere
def stop(bot, update):
    user = update.message.from_user
